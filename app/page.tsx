        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-gray-900 mb-6 leading-tight">
              Viaje <span className="text-orange-500">80% mais barato</span> com
              alertas exclusivos
            </h1>
            <p className="text-xl md:text-2xl text-gray-600 mb-8 leading-relaxed">
              Receba no WhatsApp as melhores promoções de passagens aéreas antes
              de todo mundo. Especialistas caçam ofertas 24h para você viajar
              gastando menos.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              "Economizei R$ 2.400 na minha viagem para Europa graças aos
              alertas!"
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Por que escolher a Bilhete Barato?
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Somos especialistas em encontrar as melhores ofertas de passagens
              aéreas para você viajar mais gastando menos.
            </p>
          </div>
      ...
      <section id="planos" className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Todos os planos incluem alertas em tempo real, curadoria
              especializada e dicas exclusivas para economizar
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <Card className="border-2 border-gray-200 hover:border-orange-300 transition-all duration-300 relative">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600 mb-8">
                  Acesso aos melhores alertas por 30 dias
                </p>
                <ul className="space-y-3 mb-8 text-left">
                  ...
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-3 flex-shrink-0" />
                    <span className="text-gray-700">
                      Promoções nacionais e internacionais
                    </span>
                  </li>
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-3 flex-shrink-0" />
            ...
            <Card className="border-2 border-orange-300 hover:border-orange-400 transition-all duration-300 relative">
              ...
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600 mb-8">
                  6 meses de alertas com economia garantida
                </p>
                <ul className="space-y-3 mb-8 text-left">
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-3 flex-shrink-0" />
            ...
            <Card className="border-2 border-blue-400 hover:border-blue-500 transition-all duration-300 relative bg-gradient-to-br from-blue-50 to-white">
              ...
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600 mb-8">
                  Melhor custo-benefício: planeje sua viagem com os alertas
                  enviados o ano todo e com desconto
                </p>
                <ul className="space-y-3 mb-8 text-left">
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-3 flex-shrink-0" />
        ...
        <div className="container mx-auto px-4">
          <div className="text-center text-white">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Pronto para economizar nas suas viagens?
            </h2>
            <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
              Junte-se a milhares de viajantes que já economizam com nossos
              alertas exclusivos. Comece hoje mesmo!
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center max-w-md mx-auto">
              ...
              <Button
                size="lg"
                className="bg-white text-orange-600 hover:bg-gray-100 px-8 h-12 whitespace-nowrap"
              >
                Começar Grátis
              </Button>
            </div>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">
                Especialistas em encontrar as melhores ofertas de passagens
                aéreas para você viajar mais gastando menos.
              </p>
            </div>
            <div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>
              &copy; {new Date().getFullYear()} Bilhete Barato. Todos os
              direitos reservados.
            </p>
          </div>
        </div>
